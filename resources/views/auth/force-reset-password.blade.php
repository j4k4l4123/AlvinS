...
<head>
    ...
    <title>Reset Password (Internal)</title>
    <style>
        ...
        *{box-sizing:border-box;}
        ...
        .card{width:min(640px,95vw);background:rgba(255,255,255,.96);border-radius:18px;box-shadow:0 18px 36px rgba(15,23,42,.18);overflow:hidden;border:1px solid #e2e8f0;}
        ...
        select,input[type="password"]{width:100%;padding:11px 12px;border-radius:10px;border:1px solid var(--border);font-size:.92rem;}
        select:focus,input[type="password"]:focus{outline:none;border-color:var(--primary);box-shadow:0 0 0 3px rgba(79,70,229,.15);}
...
<div class="card">
    <div class="top">
        <h1>🔐 Reset Password (Internal)</h1>
        <p>Pilih user lalu isi password baru. Password akan disimpan dengan enkripsi Vigenère.</p>
    </div>
